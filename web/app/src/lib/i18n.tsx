...
const id = {
  ...
  achievement: {
    tabs: { kurikulum: 'Kurikulum', penilaian: 'Penilaian', laporan: 'Laporan' },
    tingkat: 'Jenjang Umur',
    semester: 'Semester',
    semesterName: 'Semester {{n}}',
    addMateri: 'Tambah Materi',
    addTingkat: 'Tambah Jenjang',
    tingkatList: 'Daftar Jenjang Umur',
    tingkatBtn: 'Jenjang Umur',
    tingkatForm: 'Form Jenjang',
    tingkatNama: 'Nama Jenjang',
    urutan: 'Urutan',
    umur: 'usia {{n}} th',
    umurField: 'Usia (tahun)',
    materiForm: 'Form Materi Ajar',
    nomor: 'No.',
    tema: 'Tema',
    subTema: 'Sub Tema',
    materi: 'Materi',
    cakupan: 'Cakupan',
    jenisLabel: 'Jenis',
    jenis: { baru: 'Baru', lanjutan: 'Lanjutan', mengulang: 'Mengulang' },
    targetSemester: 'Target Semester',
    keterangan: 'Keterangan',
    confirmDeleteMateri: 'Hapus materi ini?',
    confirmDeleteTingkat: 'Hapus jenjang ini? Materi di dalamnya ikut terhapus.',
    kurikulumEditMode: 'Mode Ubah',
    searchLabel: 'Cari',
    searchPlaceholder: 'Cari materi, tema, sub tema…',
    summary: '{{count}} materi · {{temaCount}} tema · semester {{semester}}',
    student: 'Generus',
    pickStudentHint: 'Pilih generus dan jenjang umur untuk mulai menilai.',
    status: { belum: 'Belum', proses: 'Proses', tuntas: 'Tuntas' },
    nilai: 'Nilai',
    tanggal: 'Tanggal',
    ...
    grade: {
      ...
      cukup: 'Cukup',
      kurang: 'Kurang',
      empty: 'belum diajarkan',
    },
    grid: {
      title: 'Pencapaian Generus',
      search: 'Cari nama generus…',
      empty: 'Tidak ada generus ditemukan.',
  ...
  pustaka: {
    hub: {
      title: 'Pustaka',
      subtitle: 'Referensi materi dan kurikulum.',
      kurikulumTitle: 'Kurikulum',
      kurikulumSub: 'Jenjang umur, tema, dan materi ajar.',
    },
  },
...
const en: Messages = {
  ...
  achievement: {
    tabs: { kurikulum: 'Curriculum', penilaian: 'Assessment', laporan: 'Report' },
    tingkat: 'Age Group',
    semester: 'Semester',
    semesterName: 'Semester {{n}}',
    addMateri: 'Add Materi',
    addTingkat: 'Add Age Group',
    tingkatList: 'Age Groups',
    tingkatBtn: 'Age Groups',
    tingkatForm: 'Age Group Form',
    tingkatNama: 'Name',
    urutan: 'Order',
    umur: 'age {{n}}',
    umurField: 'Age (years)',
    materiForm: 'Materi Form',
    nomor: 'No.',
    tema: 'Theme',
    subTema: 'Sub Theme',
    materi: 'Materi',
    cakupan: 'Scope',
    jenisLabel: 'Type',
    jenis: { baru: 'New', lanjutan: 'Continued', mengulang: 'Repeat' },
    targetSemester: 'Target Semester',
    keterangan: 'Notes',
    confirmDeleteMateri: 'Delete this materi?',
    confirmDeleteTingkat: 'Delete this age group? Its materi will also be deleted.',
    kurikulumEditMode: 'Edit Mode',
    searchLabel: 'Search',
    searchPlaceholder: 'Search materi, theme, sub theme…',
    summary: '{{count}} materi · {{temaCount}} themes · semester {{semester}}',
    student: 'Student',
    pickStudentHint: 'Pick a student and an age group to start assessing.',
    status: { belum: 'Not yet', proses: 'In progress', tuntas: 'Done' },
    nilai: 'Score',
    tanggal: 'Date',
  ...
  pustaka: {
    hub: {
      title: 'Library',
      subtitle: 'Curriculum and learning references.',
      kurikulumTitle: 'Curriculum',
      kurikulumSub: 'Age groups, themes, and materi.',
    },
  },
