...
import { useStudentStatusLabel, useTranslation } from '@/lib/i18n'
...
function StudentsPage() {
  ...
  const { q = '', status, kelompok, page = 1, view, edit, new: isNew, bulk } = search
  ...
  return (
    <div className="space-y-4">
      ...
      <Modal open={!!bulk} onClose={close} size="xl" title={t('students.bulkTitle')}>
        <BulkPanel
          entity="students"
          isAdmin={isAdmin}
